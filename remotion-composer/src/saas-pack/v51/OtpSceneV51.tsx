// v5.1 OTP beat. Camera stage: the phone (OTP screen, code entry) + the verification
// badge — all product UI/motion preserved verbatim. Overlay: the eyebrow + headline,
// lifted out of the camera transform and pixel-snapped. Both columns stay in the
// shared centered flex row (the hidden layer renders an empty same-width phone), so
// positions are byte-identical to v5.
...
export const OtpSceneV51: React.FC<Props> = ({
  theme,
  layer,
  phoneHint = "+1 ••• 4821",
  otp = "284913",
