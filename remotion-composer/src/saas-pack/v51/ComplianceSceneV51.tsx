// v5.1 AES eIDAS beat — same as v5 ComplianceScene. The eyebrow/headline/subtitle
// are the overlay; the row of standard chips is the stage. All sit in the shared
// centered flex column in BOTH layers (opacity-toggled) so vertical positions match
// v5 exactly. Chip / ShieldCheck reproduced verbatim from the v5 template.
...
export const ComplianceSceneV51: React.FC<Props> = ({
  theme,
  layer,
  eyebrow = "Compliance",
  ...
  return (
    <AbsoluteFill style={{ justifyContent: "center", alignItems: "center", padding: 80 }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: 22, maxWidth: 1180, fontFamily: theme.type.family }}>
        ...
        <div style={{ display: "flex", gap: 22, marginTop: 26, opacity: isStage ? 1 : 0 }}>
          {standards.map((s, i) => (
